...
total_frames = input('How many frames are there in the film?')

print('OK! Let's start converting...')

for frames in range(total_frames):
  print('Converting {} frame out of {}'.format(str(frame), str(total_frames))
